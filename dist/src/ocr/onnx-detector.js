...
export class ONNXDetectionEngine {
     ...
     * @returns 检测到的区域列表
     */
    async detect(imgBuffer, imgW, imgH) {
        await this.init();
     ...
     */
    async _preprocess(imgBuffer, imgW, imgH) {
        // 计算 letterbox 缩放比例
     ...
     */
    _decodePredictions(outputData, outputDims) {
     ...
     */
    _postprocess(predictions, ratio, imgW, imgH) {
...
//# sourceMappingURL=onnx-detector.js.map